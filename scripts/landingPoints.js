(function () {
  ...
  var radiusInMeter4 = 500; // 300м
  var radiusInMeter5 = 700; // 700м
  ...
  var calcPointsDests = function () {
    ...
    var angleInDegrees3 = parseInt(angle); // спереди от цели
    ...
    L.circle(markerB, 5).addTo(layerGroup1);
    L.circle(markerC_1, 5).addTo(layerGroup1);
    L.circle(markerC_2, 5).addTo(layerGroup1);
    L.circle(markerD, 5).addTo(layerGroup1);
    L.circle(markerE, 5).addTo(layerGroup1);
    L.circle(markerF, 5).addTo(layerGroup1);
