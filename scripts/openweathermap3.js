(function($, ko) {
  ...
  var owmFcst1Url =
    "https://api.openweathermap.org/data/2.5/forecast/hourly?id=866055&lang=ru&units=metric&appid=2abe21ecc1e023a3e634fc34f9cc1ff0";
  ...
  // Onecall 59.835057 31.479017 , только почасовой на два дня
  var owmFcst1Url =
    "https://api.openweathermap.org/data/2.5/onecall?lat=59.835057&lon=31.479017&exclude=current,minutely,daily,alerts&units=metric&appid=2abe21ecc1e023a3e634fc34f9cc1ff0&lang=ru";
  ...
  function LocationViewModel(dt, temp, speed, deg, gust, desc, icon, clouds) {
    ...
    self.iconUrl = "https://openweathermap.org/img/w/" + icon + ".png";
  }
